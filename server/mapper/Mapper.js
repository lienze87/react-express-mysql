module.exports = {
  ...
  article: {
    ...
    queryByType: `select pid,author,date_utc,title,excerpt,category,comment_count from articles where category=? and status='open' order by id DESC limit ?,?`,
    queryAll: `select pid,author,date_utc,title,excerpt,category,comment_count from articles where status='open' order by id DESC limit ?,?`,
    adminQueryList:`select pid,author,date_utc,title,category,comment_status,comment_count from articles where status='open' order by id DESC limit ?,?`,
