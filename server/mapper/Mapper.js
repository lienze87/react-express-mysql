module.exports = {
  ...
  article: {
    ...
    queryById:
      "select pid,author,date_utc,title,detail_md,category,comment_count from articles where pid=?",
  ...
  comment: {
    insert:
      "insert into comments (pid,author,receiver,date_utc,content,parent_id,date_modify) values (?,?,?,?,?,?,?)",
